...
/* <applet code="studentsmark.class" width="400" height="400"></applet> */

public class studentsmark extends Applet implements ActionListener {
    ...
    public void init() {
        ...
        b.setBounds(100, 200, 100, 30); add(b);
    }
    ...
    public void paint(Graphics g) {
        ...
        if (percentage > 50) {
            g.drawArc(175, 300, 50, 20, 180, 180); // Happy
        } else {
            g.drawArc(175, 310, 50, 20, 0, 180);   // Sad
        }
    }
}
